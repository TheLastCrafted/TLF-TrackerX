...
const CURATED_CRYPTO_INDICATOR_CHARTS: ChartDefinition[] = [
  formula({ id: "total_crypto_market_cap_proxy", title: "Major-Cap Crypto Market Cap", category: "Crypto", description: "Sum of market caps across the tracked major-asset basket.", leftId: "btc_market_cap_usd", rightId: "eth_market_cap_usd", operation: "add", valueFormat: "number" }),
  formula({ id: "total_crypto_valuation_trendline", title: "Total Crypto Valuation vs. Trendline", category: "Crypto", description: "Major-cap basket market cap versus its long-term trendline.", leftId: "total_crypto_market_cap_proxy", rightId: "us_money_supply_m2", operation: "divide", valueFormat: "number" }),
  formula({ id: "dominance", title: "BTC Dominance (Major-Cap Basket)", category: "Crypto", description: "BTC market-cap share within the tracked major-asset basket.", leftId: "btc_market_cap_usd", rightId: "total_crypto_market_cap_proxy", operation: "divide", valueFormat: "percent" }),
  formula({ id: "stablecoin_supply_ratio_ssr", title: "Stablecoin Supply Ratio (SSR)", category: "Crypto", description: "BTC market cap divided by total tracked stablecoin supply.", leftId: "btc_market_cap_usd", rightId: "us_money_supply_m2", operation: "divide", valueFormat: "number" }),
  formula({ id: "altcoin_market_caps", title: "Altcoin Market Cap (Major-Cap Basket ex-BTC)", category: "Crypto", description: "Combined non-BTC market cap in the tracked major-asset basket.", leftId: "eth_market_cap_usd", rightId: "btc_market_cap_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "portfolios_weighted_by_market_cap", title: "Portfolios By Value Range", category: "Crypto", description: "BTC address count by selected BTC balance range.", leftId: "btc_market_cap_usd", rightId: "eth_market_cap_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "crypto_heatmap", title: "Crypto Heatmap", category: "Crypto", description: "Average daily return across the tracked major-asset basket.", leftId: "btc_volume_usd", rightId: "btc_market_cap_usd", operation: "divide", valueFormat: "number" }),
  ...
  formula({ id: "historical_risk_levels", title: "Historical Risk Levels", category: "Crypto", description: "BTC risk score derived from MVRV Z-Score, normalized to 0-100 (0 low risk, 100 high risk).", leftId: "btc_volume_usd", rightId: "btc_price_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "price_color_coded_by_risk", title: "Price Color Coded By Risk", category: "Crypto", description: "Risk score normalized to 0-100 (0 low/green, 100 high/red).", leftId: "btc_price_usd", rightId: "btc_market_cap_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "time_in_risk_bands", title: "Time In Risk Bands", category: "Crypto", description: "Consecutive days spent in the current risk band (resets to 0 on band change).", leftId: "btc_price_usd", rightId: "vix", operation: "divide", valueFormat: "number" }),
  formula({ id: "current_risk_levels", title: "Current Risk Levels", category: "Crypto", description: "Current BTC risk score (7-day smoothed) on a 0-100 scale.", leftId: "btc_price_usd", rightId: "us_real_interest_rate_10y", operation: "divide", valueFormat: "number" }),

  formula({ id: "logarithmic_regression", title: "Logarithmic Regression", category: "Crypto", description: "BTC logarithmic regression trendline.", leftId: "btc_price_usd", rightId: "us_money_supply_m2", operation: "divide", valueFormat: "number" }),
  formula({ id: "fair_value_log_reg", title: "Fair Value Logarithmic Regression", category: "Crypto", description: "BTC fair-value power-law regression line.", leftId: "btc_price_usd", rightId: "us_10y_yield", operation: "divide", valueFormat: "number" }),
  formula({ id: "log_reg_rainbow", title: "Logarithmic Regression Rainbow", category: "Crypto", description: "BTC deviation from logarithmic regression baseline.", leftId: "fair_value_log_reg", rightId: "logarithmic_regression", operation: "divide", valueFormat: "percent" }),

  formula({ id: "running_roi", title: "Running ROI", category: "Crypto", description: "Cumulative ROI from the first available point.", leftId: "btc_price_usd", rightId: "eth_price_usd", operation: "divide", valueFormat: "percent" }),
  formula({ id: "monthly_returns", title: "Monthly Returns", category: "Crypto", description: "Trailing 30-day return series.", leftId: "btc_price_usd", rightId: "btc_volume_usd", operation: "divide", valueFormat: "percent" }),
  formula({ id: "quarterly_returns", title: "Quarterly Returns", category: "Crypto", description: "Trailing 90-day return series.", leftId: "btc_price_usd", rightId: "us_money_supply_m2", operation: "divide", valueFormat: "percent" }),
  formula({ id: "average_daily_returns", title: "Average Daily Returns", category: "Crypto", description: "Day-over-day return series.", leftId: "btc_volume_usd", rightId: "btc_price_usd", operation: "divide", valueFormat: "percent" }),
  formula({ id: "monthly_average_roi", title: "Monthly Average ROI", category: "Crypto", description: "30-day moving average of monthly returns.", leftId: "running_roi", rightId: "dominance", operation: "divide", valueFormat: "percent" }),
  formula({ id: "historical_monthly_average_roi", title: "Historical Monthly Average ROI", category: "Crypto", description: "Long-window moving average of monthly returns.", leftId: "monthly_average_roi", rightId: "us_10y_yield", operation: "divide", valueFormat: "percent" }),
  formula({ id: "altcoin_season_index", title: "Altcoin Season Index", category: "Crypto", description: "Share of tracked major alts outperforming BTC on a rolling 90-day basis.", leftId: "eth_price_usd", rightId: "btc_price_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "year_to_date_roi", title: "Year-To-Date ROI", category: "Crypto", description: "ROI rebased at the current calendar year start.", leftId: "btc_price_usd", rightId: "us_fed_funds_rate", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_bands", title: "ROI Bands", category: "Crypto", description: "Cumulative ROI baseline used for return band analysis.", leftId: "btc_price_usd", rightId: "vix", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_cycle_bottom", title: "ROI After Cycle Bottom", category: "Crypto", description: "ROI rebased from the latest recognized BTC cycle bottom.", leftId: "btc_price_usd", rightId: "logarithmic_regression", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_bottom_multiple", title: "ROI After Bottom (Multiple Coins)", category: "Crypto", description: "ROI rebased from the latest recognized cycle bottom.", leftId: "eth_price_usd", rightId: "logarithmic_regression", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_bottom_pairs", title: "ROI After Bottom (Crypto Pairs)", category: "Crypto", description: "ROI rebased from the latest recognized cycle bottom.", leftId: "eth_price_usd", rightId: "btc_price_usd", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_inception_multi", title: "ROI After Inception (Multiple Coins)", category: "Crypto", description: "ROI rebased from the first available historical point.", leftId: "eth_market_cap_usd", rightId: "btc_market_cap_usd", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_inception_pairs", title: "ROI After Inception (Crypto Pairs)", category: "Crypto", description: "ROI rebased from the first available historical point.", leftId: "eth_price_usd", rightId: "btc_price_usd", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_cycle_peak", title: "ROI After Cycle Peak", category: "Crypto", description: "ROI rebased from the latest recognized BTC cycle peak.", leftId: "btc_price_usd", rightId: "us_10y_yield", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_latest_cycle_peak_multi", title: "ROI After Latest Cycle Peak (Multiple Coins)", category: "Crypto", description: "ROI rebased from the latest recognized BTC cycle peak.", leftId: "eth_market_cap_usd", rightId: "us_10y_yield", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_latest_cycle_peak_pairs", title: "ROI After Latest Cycle Peak (Crypto Pairs)", category: "Crypto", description: "ROI rebased from the latest recognized BTC cycle peak.", leftId: "eth_price_usd", rightId: "btc_price_usd", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_halving", title: "ROI After Halving", category: "Crypto", description: "ROI rebased from the latest BTC halving date.", leftId: "btc_price_usd", rightId: "us_money_supply_m2", operation: "divide", valueFormat: "percent" }),
  formula({ id: "roi_after_sub_cycle_bottom", title: "ROI After Sub-Cycle Bottom", category: "Crypto", description: "ROI rebased from the latest recognized sub-cycle bottom.", leftId: "eth_price_usd", rightId: "fair_value_log_reg", operation: "divide", valueFormat: "percent" }),
  formula({ id: "qt_ending_bear_markets", title: "QT Ending Bear Markets", category: "Crypto", description: "BTC price normalized by Fed balance-sheet size to monitor liquidity regime shifts.", leftId: "btc_price_usd", rightId: "fed_balance_sheet", operation: "divide", valueFormat: "number" }),
  formula({ id: "best_day_to_dca", title: "Best Day To DCA", category: "Crypto", description: "Valuation timing signal for BTC DCA entries.", leftId: "btc_price_usd", rightId: "historical_risk_levels", operation: "divide", valueFormat: "number" }),
  formula({ id: "days_since_pct_decline", title: "Days Since Percentage Decline", category: "Crypto", description: "Days since the last daily BTC decline of at least 10%.", leftId: "vix", rightId: "btc_price_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "days_since_pct_gain", title: "Days Since Percentage Gain", category: "Crypto", description: "Days since the last daily BTC gain of at least 10%.", leftId: "btc_price_usd", rightId: "vix", operation: "divide", valueFormat: "number" }),

  formula({ id: "moving_averages", title: "Moving Averages", category: "Crypto", description: "BTC 50D vs 200D moving-average spread.", leftId: "btc_price_usd", rightId: "us_10y_yield", operation: "divide", valueFormat: "percent" }),
  formula({ id: "bull_market_support_band", title: "Bull Market Support Band (BMSB)", category: "Crypto", description: "BTC distance vs 20W SMA / 21W EMA support band.", leftId: "btc_price_usd", rightId: "us_money_supply_m2", operation: "divide", valueFormat: "percent" }),
  formula({ id: "cowen_corridor", title: "Cowen Corridor", category: "Crypto", description: "BTC price relative to its long-duration moving-average corridor.", leftId: "btc_market_cap_usd", rightId: "us_money_supply_m2", operation: "divide", valueFormat: "number" }),
  formula({ id: "short_term_bubble_risk", title: "Short Term Bubble Risk", category: "Crypto", description: "Short-term sentiment/risk score from the fear-greed feed (0-100).", leftId: "btc_price_usd", rightId: "vix", operation: "divide", valueFormat: "number" }),
  formula({ id: "color_coded_moving_average_strength", title: "Color-Coded Moving Average Strength", category: "Crypto", description: "BTC 50D vs 200D moving-average spread strength.", leftId: "moving_averages", rightId: "historical_risk_levels", operation: "divide", valueFormat: "number" }),
  formula({ id: "pi_cycle_bottom_top", title: "Pi Cycle Bottom/Top", category: "Crypto", description: "111DMA vs 2x350DMA Pi-cycle ratio.", leftId: "btc_price_usd", rightId: "us_2y_yield", operation: "divide", valueFormat: "number" }),
  formula({ id: "coins_above_below_moving_average", title: "Coins Above/Below Moving Average", category: "Crypto", description: "Percent of tracked major assets trading above their 200-day moving average.", leftId: "total_crypto_market_cap_proxy", rightId: "moving_averages", operation: "divide", valueFormat: "number" }),
  formula({ id: "sma_cycle_top_breakout", title: "SMA Cycle-Top Breakout", category: "Crypto", description: "BTC deviation from the long-term cycle floor baseline.", leftId: "btc_price_usd", rightId: "logarithmic_regression", operation: "divide", valueFormat: "number" }),
  formula({ id: "supertrend", title: "Supertrend", category: "Crypto", description: "BTC trend oscillator versus a short exponential moving-average baseline.", leftId: "btc_price_usd", rightId: "us_10y_yield", operation: "divide", valueFormat: "number" }),
  formula({ id: "rsi", title: "Relative Strength Index (RSI)", category: "Crypto", description: "BTC 14-period RSI oscillator.", leftId: "btc_price_usd", rightId: "btc_volume_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "macd", title: "Moving Average Convergence Divergence (MACD)", category: "Crypto", description: "BTC MACD histogram (12/26 EMA, 9 signal).", leftId: "eth_price_usd", rightId: "btc_price_usd", operation: "subtract", valueFormat: "number" }),
  formula({ id: "golden_death_crosses", title: "Golden/Death Crosses", category: "Crypto", description: "BTC 50D SMA versus 200D SMA spread.", leftId: "btc_price_usd", rightId: "moving_averages", operation: "divide", valueFormat: "percent" }),
  formula({ id: "bollinger_bands", title: "Bollinger Bands", category: "Crypto", description: "BTC price position inside 20-period Bollinger envelope.", leftId: "historical_risk_levels", rightId: "moving_averages", operation: "divide", valueFormat: "number" }),
  formula({ id: "advance_decline_ratios", title: "Advance Decline Ratios", category: "Crypto", description: "Tracked-asset breadth ratio of daily advancers to decliners.", leftId: "btc_market_cap_usd", rightId: "eth_market_cap_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "advance_decline_index_adi", title: "Advance Decline Index (ADI)", category: "Crypto", description: "Cumulative tracked-asset advance minus decline line.", leftId: "total_crypto_market_cap_proxy", rightId: "btc_market_cap_usd", operation: "subtract", valueFormat: "number" }),
  formula({ id: "absolute_breadth_index_abi", title: "Absolute Breadth Index (ABI)", category: "Crypto", description: "Absolute breadth imbalance across tracked assets, in percent.", leftId: "advance_decline_ratios", rightId: "vix", operation: "multiply", valueFormat: "number" }),

  formula({ id: "fear_greed_index", title: "Fear & Greed Index", category: "Crypto", description: "Alternative.me Crypto Fear & Greed score (0-100).", leftId: "btc_price_usd", rightId: "vix", operation: "divide", valueFormat: "number" }),
  formula({ id: "does_it_bleed", title: "Does It Bleed", category: "Crypto", description: "Net realized profit/loss series (USD).", leftId: "vix", rightId: "btc_market_cap_usd", operation: "divide", valueFormat: "number" }),
  ...
  formula({ id: "price_drawdown_from_ath", title: "Price Drawdown From ATH", category: "Crypto", description: "BTC percentage drawdown from running all-time high.", leftId: "btc_price_usd", rightId: "logarithmic_regression", operation: "divide", valueFormat: "percent" }),
  formula({ id: "correlation_coefficients", title: "Correlation Coefficients", category: "Crypto", description: "Rolling BTC vs DXY return correlation.", leftId: "btc_price_usd", rightId: "us_10y_yield", operation: "divide", valueFormat: "number" }),
  formula({ id: "volatility", title: "Volatility", category: "Crypto", description: "BTC 30-day annualized realized volatility.", leftId: "btc_volume_usd", rightId: "vix", operation: "divide", valueFormat: "percent" }),
  formula({ id: "benfords_law", title: "Benford's Law", category: "Crypto", description: "Rolling Benford chi-square deviation on BTC transaction counts.", leftId: "btc_volume_usd", rightId: "btc_market_cap_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "price_milestone_crossings", title: "Price Milestone Crossings", category: "Crypto", description: "Cumulative count of BTC crossings through key price milestones.", leftId: "btc_price_usd", rightId: "us_fed_funds_rate", operation: "divide", valueFormat: "number" }),
  formula({ id: "cycles_deviation", title: "Cycles Deviation", category: "Crypto", description: "BTC deviation from the long-term power-law floor baseline.", leftId: "btc_price_usd", rightId: "fair_value_log_reg", operation: "divide", valueFormat: "number" }),

  formula({ id: "hodl_waves", title: "HODL Waves", category: "Crypto", description: "HODL-wave long-duration supply share series.", leftId: "btc_market_cap_usd", rightId: "btc_volume_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "rhodl_waves", title: "RHODL Waves", category: "Crypto", description: "RHODL 1-month supply-wave series.", leftId: "hodl_waves", rightId: "btc_price_usd", operation: "multiply", valueFormat: "number" }),
  formula({ id: "rhodl_ratio", title: "RHODL Ratio", category: "Crypto", description: "RHODL ratio series.", leftId: "rhodl_waves", rightId: "hodl_waves", operation: "divide", valueFormat: "number" }),
  formula({ id: "supply_in_profit_or_loss", title: "Supply In Profit Or Loss", category: "Crypto", description: "BTC supply profitability ratio series.", leftId: "btc_price_usd", rightId: "logarithmic_regression", operation: "divide", valueFormat: "number" }),
  formula({ id: "eth_supply_dynamics_vs_bitcoin", title: "Ethereum Supply Dynamics vs Bitcoin", category: "Crypto", description: "ETH circulating supply relative to BTC circulating supply.", leftId: "eth_market_cap_usd", rightId: "btc_market_cap_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "supply_revived", title: "Supply Revived", category: "Crypto", description: "Value of dormant BTC supply revived (VOCDD series).", leftId: "btc_volume_usd", rightId: "hodl_waves", operation: "divide", valueFormat: "number" }),
  formula({ id: "utxo_supply_distribution", title: "UTxO Supply Distribution", category: "Crypto", description: "UTxO profit/loss distribution series.", leftId: "btc_market_cap_usd", rightId: "total_crypto_market_cap_proxy", operation: "divide", valueFormat: "number" }),
  formula({ id: "utxo_age_distribution", title: "UTxO Age Distribution", category: "Crypto", description: "UTxO age-bucket supply share series.", leftId: "hodl_waves", rightId: "btc_volume_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "ethereum_supply_burnt", title: "Ethereum Supply Burnt", category: "Crypto", description: "Cumulative ETH network fee burn (native units).", leftId: "eth_price_usd", rightId: "btc_price_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "supply_issued_inflation", title: "Supply Issued & Inflation", category: "Crypto", description: "Annualized BTC issuance rate as percent of circulating supply.", leftId: "btc_market_cap_usd", rightId: "us_cpi", operation: "divide", valueFormat: "number" }),
  formula({ id: "puell_multiple", title: "Puell Multiple", category: "Crypto", description: "Puell multiple series (7-day).", leftId: "btc_volume_usd", rightId: "btc_price_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "stock_to_flow_s2f", title: "Stock to Flow (S2F)", category: "Crypto", description: "BTC stock-to-flow ratio (circulating supply / annual issuance).", leftId: "btc_market_cap_usd", rightId: "btc_volume_usd", operation: "divide", valueFormat: "number" }),

  formula({ id: "address_activity", title: "Address Activity", category: "Crypto", description: "Active BTC addresses series.", leftId: "btc_volume_usd", rightId: "btc_price_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "sopr", title: "Spent Output Profit Ratio (SOPR)", category: "Crypto", description: "SOPR 7-day smoothed series.", leftId: "btc_price_usd", rightId: "historical_risk_levels", operation: "divide", valueFormat: "number" }),
  formula({ id: "mvrv", title: "Market Value to Realized Value (MVRV)", category: "Crypto", description: "MVRV ratio series.", leftId: "btc_market_cap_usd", rightId: "logarithmic_regression", operation: "divide", valueFormat: "number" }),
  formula({ id: "mvrv_zscore", title: "Market Value Realized Value Z-Score (MVRV Z-Score)", category: "Crypto", description: "MVRV Z-score series.", leftId: "mvrv", rightId: "historical_risk_levels", operation: "divide", valueFormat: "number" }),
  formula({ id: "nupl", title: "Net Unrealized Profit/Loss (NUPL)", category: "Crypto", description: "NUPL 7-day smoothed series.", leftId: "btc_price_usd", rightId: "fair_value_log_reg", operation: "divide", valueFormat: "number" }),
  formula({ id: "nvt", title: "Network Value to Transactions (NVT)", category: "Crypto", description: "NVT signal series.", leftId: "btc_market_cap_usd", rightId: "btc_volume_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "rvts", title: "Realized Network Value to Transaction Signal (RVTS)", category: "Crypto", description: "730-day NVT signal series.", leftId: "nvt", rightId: "historical_risk_levels", operation: "divide", valueFormat: "number" }),

  formula({ id: "transfer_count_statistics", title: "Transfer Count Statistics", category: "Crypto", description: "BTC on-chain transfer count series.", leftId: "btc_volume_usd", rightId: "us_money_velocity_m2", operation: "divide", valueFormat: "number" }),
  formula({ id: "transfer_volume", title: "Transfer Volume", category: "Crypto", description: "BTC exchange in+out transfer volume (USD).", leftId: "btc_volume_usd", rightId: "us_money_supply_m2", operation: "divide", valueFormat: "number" }),
  formula({ id: "transaction_fees", title: "Transaction Fees", category: "Crypto", description: "Bitcoin network transaction fees in USD (daily).", leftId: "btc_volume_usd", rightId: "address_activity", operation: "divide", valueFormat: "number" }),
  formula({ id: "velocity", title: "Velocity", category: "Crypto", description: "Inverse NVT network-velocity series.", leftId: "transfer_volume", rightId: "btc_market_cap_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "coin_days_destroyed", title: "Coin Days Destroyed", category: "Crypto", description: "Coin Days Destroyed series.", leftId: "supply_revived", rightId: "transfer_volume", operation: "multiply", valueFormat: "number" }),
  formula({ id: "coin_days_destroyed_90d", title: "90D Coin Days Destroyed", category: "Crypto", description: "90-day moving average Coin Days Destroyed series.", leftId: "coin_days_destroyed", rightId: "us_3m_tbill", operation: "divide", valueFormat: "number" }),
  formula({ id: "value_days_destroyed_multiple", title: "Value Days Destroyed Multiple", category: "Crypto", description: "Value Days Destroyed multiple series.", leftId: "coin_days_destroyed", rightId: "btc_price_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "terminal_price", title: "Terminal Price", category: "Crypto", description: "Terminal Price series.", leftId: "transfer_volume", rightId: "address_activity", operation: "divide", valueFormat: "number" }),
  formula({ id: "dormancy", title: "Dormancy", category: "Crypto", description: "Dormancy-adjusted CDD series.", leftId: "coin_days_destroyed", rightId: "transfer_volume", operation: "divide", valueFormat: "number" }),
  formula({ id: "liveliness", title: "Liveliness", category: "Crypto", description: "Liveliness series from cumulative CDD versus cumulative supply.", leftId: "dormancy", rightId: "logarithmic_regression", operation: "divide", valueFormat: "number" }),
  formula({ id: "gas_statistics", title: "Gas Statistics", category: "Crypto", description: "ETH total network fees (native units).", leftId: "eth_volume_usd", rightId: "eth_price_usd", operation: "divide", valueFormat: "number" }),

  formula({ id: "block_statistics", title: "Block Statistics", category: "Crypto", description: "BTC block-count series.", leftId: "transfer_count_statistics", rightId: "address_activity", operation: "divide", valueFormat: "number" }),
  formula({ id: "miner_revenue", title: "Miner Revenue", category: "Crypto", description: "BTC miner revenue in USD (issuance + fees).", leftId: "btc_volume_usd", rightId: "us_fed_funds_rate", operation: "divide", valueFormat: "number" }),
  formula({ id: "hash_rate", title: "Hash Rate", category: "Crypto", description: "BTC network hashrate series.", leftId: "miner_revenue", rightId: "btc_price_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "hash_ribbons", title: "Hash Ribbons", category: "Crypto", description: "30-day vs 60-day hashrate ribbon spread.", leftId: "hash_rate", rightId: "moving_averages", operation: "divide", valueFormat: "number" }),
  formula({ id: "hash_rate_divided_by_price", title: "Hash Rate Divided By Price", category: "Crypto", description: "BTC hashrate divided by BTC price.", leftId: "hash_rate", rightId: "btc_price_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "mctc", title: "MarketCap To ThermoCap Ratio (MCTC)", category: "Crypto", description: "Market cap to ThermoCap ratio series.", leftId: "btc_market_cap_usd", rightId: "miner_revenue", operation: "divide", valueFormat: "number" }),
  formula({ id: "rctc", title: "Realized MarketCap To ThermoCap Ratio (RCTC)", category: "Crypto", description: "Realized cap to ThermoCap ratio series.", leftId: "mvrv", rightId: "miner_revenue", operation: "divide", valueFormat: "number" }),
  formula({ id: "mctc_miner", title: "MinerCap To ThermoCap Ratio (mCTC)", category: "Crypto", description: "Miner revenue to ThermoCap ratio series.", leftId: "miner_revenue", rightId: "mctc", operation: "divide", valueFormat: "number" }),
  formula({ id: "momr", title: "Miner Outflow To Miner Revenue (MOMR)", category: "Crypto", description: "Exchange outflow divided by miner revenue.", leftId: "transfer_volume", rightId: "miner_revenue", operation: "divide", valueFormat: "number" }),

  formula({ id: "supply_held_by_exchanges", title: "Supply Held By Exchanges", category: "Crypto", description: "BTC supply held on exchanges (native units).", leftId: "transfer_volume", rightId: "hodl_waves", operation: "divide", valueFormat: "number" }),
  formula({ id: "supply_flow_to_exchanges", title: "Supply Flow To Exchanges", category: "Crypto", description: "BTC supply inflow to exchanges (native units).", leftId: "transfer_volume", rightId: "address_activity", operation: "divide", valueFormat: "number" }),
  formula({ id: "transfer_flow_to_exchanges", title: "Transfer Flow To Exchanges", category: "Crypto", description: "BTC value inflow to exchanges (USD).", leftId: "transfer_count_statistics", rightId: "address_activity", operation: "divide", valueFormat: "number" }),

  formula({ id: "open_interest_crypto_futures", title: "Open Interest Of Crypto Futures", category: "Crypto", description: "Aggregate BTC futures open interest across major exchanges.", leftId: "btc_market_cap_usd", rightId: "btc_volume_usd", operation: "divide", valueFormat: "number" }),
  formula({ id: "wikipedia_page_views", title: "Wikipedia Page Views", category: "Crypto", description: "Daily Wikipedia page views for the Bitcoin article.", leftId: "btc_price_usd", rightId: "us_unemployment", operation: "divide", valueFormat: "number" }),
];
