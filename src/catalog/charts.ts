...
const CURATED_CRYPTO_INDICATOR_CHARTS: ChartDefinition[] = [
  ...
  formula({ id: "fair_value_log_reg", title: "Fair Value Logarithmic Regression", category: "Crypto", description: "BTC fair-value line derived from regression residual band.", leftId: "btc_price_usd", rightId: "us_10y_yield", operation: "divide", valueFormat: "number" }),
